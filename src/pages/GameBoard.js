  ...
  return (
    <div id="main-gameboard">
      ...
      <div className="player-one">
        ...
        <NameInput onClick={winner1Click} onChange={handleChange} />
      </div>
      ...
      <div className="player-three">
        ...
        <NameInput onClick={winner2Click} onChange={handleChange} />
      </div>
      ...
      <div className="player-five">
        ...
        <NameInput onClick={winner3Click} onChange={handleChange} />
      </div>
      ...
      <div className="player-seven">
        ...
        <NameInput onClick={winner4Click} onChange={handleChange} />
      </div>
